...
// let curry = f => x => y => f(x, y)
let replace = curry((regex, replacement, str) => str.replace(regex, replacement))
let replace_vowels = replace(/[aeiou]/ig,'!', 'Hey I have words')
// let replace_symbol = replace_vowels('!')
// result = replace_symbol(('Hey I have words'))
console.log(replace_vowels)